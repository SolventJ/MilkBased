...
public class MilkBoatItem extends Item {
    private static final Predicate<Entity> ENTITY_PREDICATE = EntitySelector.NO_SPECTATORS.and(Entity::isPickable);
    private final MilkBoat.BoatFactory factory;

    public MilkBoatItem(MilkBoat.BoatFactory factory, Item.Properties properties) {
        super(properties);
    ...
    private Boat getBoat(Level level, HitResult hitResult, ItemStack stack, Player player) {
        ...
        Boat boat = factory.create(level, vec3.x, vec3.y, vec3.z);
